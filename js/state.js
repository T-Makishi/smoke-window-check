export const createDraft=()=>({
  ...
  estimate:null,presentedResult:null,inspectionFee:{amount:8000,taxType:'included',chargeWhenInspectionOnly:true,deductionOnFormalOrder:8000,agreed:false,agreedAt:null},media:{count:0,saved:false,names:[]},submission:{agreed:false,serverId:'',caseNumber:'',emailStatus:'',sentAt:''},status:'unconfirmed',memo:''
});
